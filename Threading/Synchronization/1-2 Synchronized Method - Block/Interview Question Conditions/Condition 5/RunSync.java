...
class Shared{
	...
	synchronized void show1(String str, int x){
		Shared.x = x;
		System.out.println("Start Show1: Thread Name is: " + str + " and value of x: " + x);
		...
		System.out.println("Exit Show1: Thread Name is " + str + " and value of x: " +  x);	
	}
}
